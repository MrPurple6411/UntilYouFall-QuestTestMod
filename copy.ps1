...
if ($help -eq $true) {
    echo "`"Copy`" - Builds and copies your mod to your quest, and also starts Until You Fall with optional logging"
    echo "`n-- Arguments --`n"
    ...
    echo "-Log `t`t Logs Until You Fall using the `"Start-Logging`" command"
